This is an etch a sketch project for The Odin Project course. 

The goal is to test my DOM manipulation skills building a canvas that can be used as a drawing whiteboard
for a user. 

following, i'm copy-pasting the assignment of the excercise: 
...
Don’t forget to commit early and often! You can reference the Commit Messages lesson!
  ...
  1  Follow our instructions on setting up your project’s GitHub repository.     DONE
